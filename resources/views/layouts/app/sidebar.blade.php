        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:sidebar.item icon="user-group" :href="route('visitors')" :current="request()->routeIs('visitors')" wire:navigate>
                        {{ __('Visitors') }}
                    </flux:sidebar.item>
                    ...
                    <flux:sidebar.item icon="flag" :href="route('watchlist')" :current="request()->routeIs('watchlist')" wire:navigate>
                        {{ __('Watchlist') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>
            </flux:sidebar.nav>
